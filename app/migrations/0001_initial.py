    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_currency', models.CharField(blank=True, choices=[('$', '$'), ('₦', '₦'), ('€', '€'), ('£', '£'), ('₹', '₹')], default='$', max_length=100, null=True)),
                ...
                ('user_password_in_plaintext', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('has_submitted_kyc', models.BooleanField(default=False, verbose_name='User has submitted verification for KYC')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ssn', models.CharField(blank=True, max_length=500, null=True)),
                ('receipt', models.FileField(blank=True, help_text='This is the receipt of account payment confirmation.', null=True, upload_to='identity/proof')),
                ...
                ('bank_name', models.CharField(blank=True, default='Optimum Bank', max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card_passcode', models.CharField(blank=True, max_length=100, null=True)),
                ('activated', models.BooleanField(default=False)),
